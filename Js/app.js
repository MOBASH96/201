"use strict";
// welcome user and scurity question
...
for (var i = 0; rndNo != check; i++) {
  if (rndNo === check) {
    ...
    check = prompt("are yor a repote, please enter this number " + rndNo);
  }
}
...
if (FQ === true) {
  ...
  alert(
    "I hope to know you soon" +
      userName +
      "but now please answer those qustion "
  );
}
// yes no qustions
...
var fthQ = prompt(
  " is my currant traning program is Softwere developer? (Y,N)"
);
...
function firstQuestion() {
  ...
  for (var i = 0; i < 6; i++) {
    ...
    if (
      InputAnswer === AnswersArray[0] ||
      InputAnswer === AnswersArray[1] ||
      InputAnswer === AnswersArray[2]
    ) {
      z++;
      userScore++;
      if (z === 3) {
...
function secondQuestion() {
  ...
  for (var i = 0; i < 6; i++) {
    ...
    if (
      InputAnswer.toLowerCase() === AnswersArray[0] ||
      InputAnswer.toLowerCase() === AnswersArray[1] ||
      InputAnswer.toLowerCase() === AnswersArray[2]
    ) {
      z++;
      userScore++;
      if (z === 3) {
...
function fifthQuestion() {
  ...
  for (var i = 0; i < 6; i++) {
    ...
    if (
      InputAnswer.toUpperCase() === AnswersArray[0] ||
      InputAnswer.toUpperCase() === AnswersArray[1] ||
      InputAnswer.toUpperCase() === AnswersArray[2]
    ) {
      z++;
      userScore++;
      if (z === 3) {
...
function sixthQuestion() {
  ...
  var z = 0;
  for (var i = 0; i < 6; i++) {
    var InputAnswer = prompt(
      "Can you guess my  approxmate  high school mark ?"
    );
    if (
      InputAnswer.toUpperCase() === AnswersArray[0] ||
      InputAnswer.toUpperCase() === AnswersArray[1] ||
...
function seventhQuestion() {
  ...
  for (var i = 0; i < 6; i++) {
    var InputAnswer = prompt(
      "Can you guess my approxmate  BA GPA ( Out of 4)  ?"
    );
    if (
      InputAnswer.toUpperCase() === AnswersArray[0] ||
      InputAnswer.toUpperCase() === AnswersArray[1] ||
